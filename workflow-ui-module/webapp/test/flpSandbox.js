		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cashworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cashworkflowuimodule-display": {
								"semanticObject": "cashworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cash.workflowuimodule",
									"url": sap.ui.require.toUrl("cash/workflowuimodule")
								}
							}
						}
					}
